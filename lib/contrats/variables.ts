...
export const VARIABLES_CONTRAT: VariableContrat[] = [
  ...
  { cle: "mandant_naissance", description: "Date de naissance du mandant" },
  { cle: "mandant_lieu_naissance", description: "Lieu de naissance du mandant" },
  { cle: "mandant_cni", description: "N° de pièce d'identité du mandant" },
