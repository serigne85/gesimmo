...
export default function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-sable-200/70 bg-sable-50/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-full bg-bleu-profond px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-bleu-profond-hover"
        >
