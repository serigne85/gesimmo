...
export default function NonTrouve() {
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-24 text-center sm:px-6">
      <span className="grid h-14 w-14 place-items-center rounded-2xl bg-marine/10 text-marine">
      ...
      <Link
        href="/nos-biens"
        className="mt-8 inline-flex items-center gap-2 rounded-full bg-marine px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-marine-hover"
      >
